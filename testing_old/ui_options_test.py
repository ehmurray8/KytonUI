...
class OptionsFrame(tk.Frame):
    def __init__(self, master=None):
        ...
        self.controller_text = None
        self.oven_text = None
        self.interrogator_ip_text = None
        self.interrogator_port_text = None
        self.drift_number_text = None
        self.wait_time_text = None
        self.set_point_list_text = None
        self.dwell_text = None
        self.ranges_text = None
...
if __name__ == '__main__':
    root = tk.Tk()
    root.wm_title("Options Panel")
    opt_box = OptionsFrame()
    root.mainloop()
